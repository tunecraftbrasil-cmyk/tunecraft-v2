...
1. Use NO MÍNIMO 10 detalhes específicos das respostas do cliente. Nada genérico.
2. Inclua pelo menos 3 imagens/cenas concretas e distintas:
   - Uma do PASSADO (memória, história compartilhada, origem)
   - Uma do PRESENTE (momento atual, situação específica)
   - Uma do FUTURO (esperança, sonho, promessa, destino)
3. Use o nome do destinatário em momentos-chave:
   - Pelo menos uma vez no início ou verso 1
   - Pelo menos uma vez em um refrão
   - Opcionalmente no final ou ponte (se fizer sentido emocional)
4. PROÍBIDO usar frases vazias. Exemplos PROIBIDOS:
   - "você é tudo pra mim" (sem contexto específico)
   - "amor eterno" (sem conexão com detalhes da relação)
   - "sempre vou te amar" (clichê sem motivo específico)
   - "você é a razão da minha felicidade" (genérico demais)
   → Se PRECISAR usar algo assim, conecte IMEDIATAMENTE a um detalhe específico na mesma linha ou na seguinte.
5. A letra deve ser absolutamente impossível de reutilizar para outra pessoa.

═══════════════════════════════════════════════════════════════════

ESTRUTURA E DURAÇÃO:
- A música deve ter extensão equivalente a PELO MENOS 3-4 minutos quando cantada/produzida.
...
- Estrutura FLEXÍVEL, não engessada:
  • Pop: pode ser Verso/Pré-Refrão/Refrão/Verso/Refrão/Ponte/Refrão+Outro
  • Sertanejo: pode ser Introdução/Verso/Refrão/Verso/Refrão/Ponte/Refrão final
  • Balada: pode ser Verso longo/Refrão/Verso/Refrão/Ponte profunda/Refrão final estendido
  • MPB: pode ser Verso/Verso/Refrão/Verso/Refrão/Ponte/Verso/Refrão final
  • Rock: pode ser Verso/Verso/Pré-Refrão/Refrão/Solo/Verso/Refrão/Ponte épica/Refrão final +Outro
  • Oração/Balada intimista: Verso/Verso/Refrão/Verso/Ponte contemplativa/Refrão final suave
...
- DEVE incluir:
  ...
  • Atmosfera (warm, nostalgic, celebratory, intimate, powerful, melancholic, hopeful, epic)
  • Instrumentação principal (acoustic guitar, piano, strings, drums, pads, horns, etc)
  • Tipo/estilo vocal (soft male vocals, powerful female vocals, intimate duet, anthemic chorus, etc)
  • Tempo/andamento inferido (slow, midtempo, uptempo, energetic, contemplative)
- EXEMPLOS BOM FORMATADAS:
  ✓ "intimate midtempo acoustic pop ballad with warm piano, gentle strings and emotional male-female duet vocals"
  ✓ "upbeat modern sertanejo pop with lively acoustic guitar, warm percussion and joyful female vocals"
  ✓ "powerful epic rock ballad with soaring strings, intense drums and anthemic male vocals"
  ✓ "contemplative acoustic folk-pop with fingerpicked guitar, subtle strings and warm intimate vocals"
...
2. Identifique os 10+ detalhes mais específicos e emocionais.
...
7. Use o nome do destinatário em momentos-chave (min. 2 vezes).
